...
const OTBM = ({ handleNext, accessToken, capturedData, capturedDataHandler }) => {
  ...
  const handleSubmit = async (event) => {
    ...
    axios.post(`${process.env.REACT_APP_BACKEND_HOST}v1/user/investment/otbm`, {...formData,Pan:capturedData.pan,Folio:capturedData.folio,inv_id:capturedData.inv_id},
      {
