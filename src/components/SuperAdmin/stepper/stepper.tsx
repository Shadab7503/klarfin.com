          ...
          <div style={{ minHeight: '80vh' }}>
            ...
            <div style={{ marginTop: '4rem' }}>
            
              {
                ...
                activeStep == 0 && <Investment capturedDataHandler={dataCapture} accessToken={accessToken} handleNext={handleNext} />

              }

              {

              activeStep == 1 && <KYCCheck accessToken={accessToken} capturedDataHandler={dataCapture} capturedData={capturedData}  handleNext={handleNext} />

              }

              {

                activeStep == 2 && <Folio capturedDataHandler={dataCapture} capturedData={capturedData} handleNext={handleNext} accessToken={accessToken} />

              }
              {

                activeStep == 3 && <OTBM capturedDataHandler={dataCapture} capturedData={capturedData} handleNext={handleNext} accessToken={accessToken} />
